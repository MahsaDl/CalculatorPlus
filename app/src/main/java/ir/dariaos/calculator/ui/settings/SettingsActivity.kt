package ir.dariaos.calculator.ui.settings
...
import ir.dariaos.calculator.databinding.ColorDialogBinding
...
class SettingsActivity : BaseActivity<ActivitySettingsBinding>() {
    ...
    companion object {
        const val DOWNLOAD_LINK =
            "https://play.google.com/store/apps/details?id=ir.dariaos.calculator"
